...
class layer_slider{
    ...
    function output(){
        $list = $this->get_list();
        $str='
        <div id="layerslider_1" class="ls-wp-container" style="height:380px;margin:0 auto;padding:0">';
        foreach($list as $item){
            ...
            if(trim($item['title'])!=''){
                $str.='
                <p class="ls-l title" style="top:100px;left:60px;font-size:20px" data-ls="offsetxin:0;durationin:2500;delayin:2000;rotateyin:90;transformoriginin:left 50% 0;offsetxout:0;rotateyout:-90;transformoriginout:left 50% 0;">
                '.$item['title'].'
                </p>';
            }
            if(trim($item['sum'])!=''){
                $str.='
                <p class="ls-l" style="max-width:800px;top:150px;left:60px;font-size:13px;line-height:28px;color:#fff;background:rgba(0,0,0,0.5);padding:10px" data-ls="offsetxin:0;durationin:2000;delayin:3500;">
                '.nl2br(common::str_cut($item['sum'],300)).'
                </p>';
            }
            if(trim($item['lnk'])!=''){
                $str.='
                <p class="ls-l" style="top:250px;left:60px; border-radius: 3px; color: #FFFFFF; cursor: pointer; display: inline-block; line-height: 50px; outline: medium none; position: relative; text-transform: capitalize; transition: all 0.3s ease 0s; z-index: 1; background: none repeat scroll 0 0 #263944; padding: 0 20px; font-size:16px; font-weight:300;white-space: nowrap;" data-ls="offsetxin:0;durationin:400;delayin:4500;easingin:linear;rotateyin:90;transformoriginin:left 50% 0;offsetxout:0;durationout:100;showuntil:5400;easingout:linear;rotateyout:90;transformoriginout:left 50% 0;">
